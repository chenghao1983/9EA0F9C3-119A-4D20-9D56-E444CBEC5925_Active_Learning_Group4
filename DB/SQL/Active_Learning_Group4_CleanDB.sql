...
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (1, N'Admin1', N'/pgdZNxfSu2XUHjBNgaB4PlwinBAUmTH', 'Super Admin', 1, CAST(N'2016-04-13 23:15:17.527' AS DateTime), NULL, NULL, N'A',N'ZB/sYHfiuxnSFd/ZoMZMfNqAW+MpQu5x ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (2, N'Instructor1', N'Knn5u702hV4P2EqaUDzadGiPZ4zuT79n', 'Kent White', 1, CAST(N'2016-04-13 23:17:34.010' AS DateTime), NULL, NULL, N'I',N'C0xyFiz5b3ZacMTRPwKleI0eFaSy0x8C ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (3, N'Instructor2', N'XofVKJP8RDq8YzvKGD/iAsLJeXfZ5Rjq', 'Eric Johnson', 1, CAST(N'2016-04-13 23:17:41.910' AS DateTime), NULL, NULL, N'I',N'0OTW6ch2NjxC1q7sIYl586hQMzftY+Wd ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (4, N'Instructor3', N'mY02CzdWEumV7hYOrzBhzbubActepQ0n', 'Tom Cruise', 1, CAST(N'2016-04-13 23:18:59.883' AS DateTime), NULL, NULL, N'I',N'hTJOxnbQmKLChQqOwKBv6s6BCRrE2riL ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (5, N'Instructor4', N'nK8GhoBWuqQJOUawnZyf5ASlcztJShys', 'Walker Smith', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'I',N'i2k7XSN+Gi8kDpq9feHX2H7zMjVx4dGR ')
GO
...
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (7, N'Instructor6', N'cBX1eOFJAIBG3NhFqatFXLsULpOin03N', 'Alexandros Hafiz', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'I',N'cxxx/Zd2AKXaUaNAze+t20MF+gCnbMFZ ')
GO
...
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (9, N'Instructor8', N'c+4gS/HEc6jWPhOCLTTfHFkhrW3acoKr', 'Codie Lucinda', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'I',N'VklxCbwR/oHKBRV6npO0VmbAvbR46Sd/ ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (10, N'Instructor9', N'WVXy4pzZyPi8+Y96P9I3efun1hG2Cth1', 'Torger Kayleen',1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'I',N'VJkbnSovc1BtPy04RybAo8B8sAAwTn2J ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (11, N'Instructor10', N'1b9xGQFHIJP23C0TneF6Prk7vwzl13h/', 'Filippa Cynbel', 0, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'I',N'cZZ7m8Sj5pv4Ag7hP8ot9ZqDCHbrOooI ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (12, N'Student1', N'cqetgRDPjq08inW+s8qrvR+ziarhTT5K', 'Adil Hayati', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'KrTW84isQkhtiMQxzbwLKfIsLmOhobSY ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (13, N'Student2', N'l9oS2i4DLrNo+LN8xAEX4tlUwrjUBRMU', 'Mette Iris', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'HKjH9qgCG1tyVMVcEIJXdxtxJ5bXYufr ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (14, N'Student3', N'/dO8iUzskF4rg5vcphZ1RM30KVD/XIT3', 'Amelia Funanya', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'8YQJqFAV9xUWwHiXfODFuhuDTS5ukQwt ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (15, N'Student4', N'nidi1WDuq7QGHwhDzYnHVA+MYCJTvS6u', 'Jurgen Sofia', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'yKV616WHc2i8rUKGMXMhskBWkWXm4AQC ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (16, N'Student5', N'Erg+QqPJGkLWqOIBArm0FIdpbq+RvA91', 'Athena Herbert', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'7bDVnI3WlC1q2ApB+ASvPHsZwKjkvBzZ ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (17, N'Student6', N'9npJ2Ze8zn7A8Yy45pPNBh257buakJUU', 'Chrissy Ambre', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'4c08nVFZyiI73vZd9P7bEuBvpvHJhYZO ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (18, N'Student7', N'B8yBLO6nCXHufgWGRpMACnQZrLcYmdWl', 'Faddei Kir', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'FHBd7pjdeFwdNJaRJPzxdfpg/zXWChDx ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (19, N'Student8', N'jvi05pAI/dm8pZjQ9UmKCSKFLH8zgi8E', 'Sima Folke', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'qDzmSff2D9K2BlhQYrZ6YfGB1BETav+j ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (20, N'Student9', N'8Ng1msqgKtsWAzZKUt1giB5L8WkYjWPt', 'Wendelin Jaci', 1, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'zK1HYfERIWKCtu3djAlZD8SheRXI7w6B ')
GO
INSERT [dbo].[User] ([Sid], [Username], [Password], [FullName], [IsActive], [CreateDT], [UpdateDT], [DeleteDT], [Role], [PasswordSalt]) VALUES (21, N'Student10', N'xdGMVptwdgRfXywbtvE0NiOd1J7cja78', 'Valencia Demeter', 0, CAST(N'2016-04-13 23:21:00.933' AS DateTime), NULL, NULL, N'S',N'JolFZ40Wq1Hz3Jfuo4NhIt+BQL06TmFZ ')
GO
