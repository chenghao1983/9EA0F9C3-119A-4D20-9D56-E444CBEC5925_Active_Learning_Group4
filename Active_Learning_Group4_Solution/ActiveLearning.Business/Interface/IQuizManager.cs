...
namespace ActiveLearning.Business.Interface
{
    public interface IQuizManager
    {
        ...
        bool UpdateQuizQuestion(QuizQuestion quizQuestionSid, out string message);
        ...
        QuizAnswer AddQuizAnswerToQuizQuestionAndOption(QuizAnswer quizAnswer, int quizQuestionSid, int quizOptionSid, out string message);
