...
namespace ActiveLearning.Business.Interface
{
    public interface IUserManager
    {
        ...
        Student GetStudentByStudentSid(int sid, out string message);
        ...
        Instructor GetInstructorByInstructorSid(int sid, out string message);
        ...
        Admin GetAdminByAdminSid(int sid, out string message);
