...
namespace ActiveLearning.Business.Interface
{
    public interface ICourseManager
    {
        ...
        bool EnrolStudentsToCourse(IEnumerable<int> studentSids, int courSid, out string message);
        ...
        bool EnrolInstructorsToCourse(IEnumerable<Instructor> Instructors, int courSid, out string message);
        bool EnrolInstructorsToCourse(IEnumerable<int> InstructorSids, int courSid, out string message);
